      ...
      >
        {#if !spAuthed}
          ...
          <button
            onclick={spConnect}
            disabled={spLoading}
            class="flex flex-col items-center gap-3 m-3 py-8 rounded-lg border border-dashed hover:bg-white/10 transition disabled:opacity-50"
            style="border-color:rgba(29,185,84,0.5)"
          >
            <svg viewBox="0 0 24 24" class="w-8 h-8" style="color:#1db954">
            ...
            <div class="flex flex-col items-center gap-0.5">
              ...
              <span class="text-[9px]" style="color:rgba(255,255,255,0.4)">Click to authenticate</span>
            </div>
          </button>
